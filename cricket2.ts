...
let hit1:HTMLButtonElement = <HTMLButtonElement>document.getElementById("hit1");
let hit2:HTMLButtonElement = <HTMLButtonElement>document.getElementById("hit2");
let score = [document.getElementById("span1"),document.getElementById("span2")];
hit2.disabled = true;
let results:HTMLButtonElement = <HTMLButtonElement>document.getElementById("results");
results.disabled = true;
let t1 = [<HTMLTableElement>document.getElementById("table1"),<HTMLTableElement>document.getElementById("table2")];
